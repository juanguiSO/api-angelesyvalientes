...
/**
 * Interfaz de repositorio de Spring Data JPA para entidades {@link TipoIdentificacion}.
 *
 * <p>Esta interfaz extiende {@link JpaRepository}, proporcionando operaciones CRUD
 * (Crear, Leer, Actualizar, Borrar) estándar para la entidad {@link TipoIdentificacion}.
 * Las operaciones de persistencia subyacentes son gestionadas por la implementación
 * de Spring Data JPA.</p>
 *
 * <p>El repositorio gestiona entidades {@link TipoIdentificacion}, donde la clave primaria
 ...
 *
 * @see TipoIdentificacion La clase de entidad gestionada por este repositorio, representando un tipo de identificación.
...
public interface TipoIdentificacionRepository  extends JpaRepository<TipoIdentificacion, Long> {
    ...
    // - save(TipoIdentificacion entity) -> guardar
